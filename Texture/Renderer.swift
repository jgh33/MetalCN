...
class Renderer: NSObject {
    ...
    init?(with view: MTKView) {
        ...
        let quadVertices = [
            Vertex(vector_float2(250, -250), vector_float2(1, 1)),
            Vertex(vector_float2(-250, -250), vector_float2(0, 1)),
            Vertex(vector_float2(-250, 250), vector_float2(0, 0)),
            
            Vertex(vector_float2(250, -250), vector_float2(1, 1)),
            Vertex(vector_float2(-250, 250), vector_float2(0, 0)),
            Vertex(vector_float2(250, 250), vector_float2(1, 0)),
        ]
        
        vertices = device.makeBuffer(bytes: quadVertices, length: MemoryLayout<Vertex>.size * 6, options: .storageModeShared)!
